...
public partial class HDevelopExport
{
  public HTuple hv_ExpDefaultWinHandle;
      ...
      HTuple hv_Row, HTuple hv_Column, HTuple hv_Color, HTuple hv_Box)
    {
        ...
        else if ((int)(new HTuple(hv_Box.TupleNotEqual("true"))) != 0)
        {
  ...
  HTuple hv_boxWidth, HTuple hv_boxHeight, HTuple hv_boxBenginX, HTuple hv_medianKernal,
  HTuple hv_dynThresh, HTuple hv_defectArea, HTuple hv_standardTupleL, HTuple hv_standardTupleA,
  HTuple hv_standardTupleB, HTuple hv_clothAberrationGrad1, HTuple hv_clothAberrationGrad2,
  HTuple hv_clothAberrationGrad3, HTuple hv_clothAberrationGrad4, out HTuple hv_result,
  ...
  out HTuple hv_A, out HTuple hv_B)
    {
        ...
        HObject ho_DefectRegion, ho_GrayImage, ho_Region;
        HObject ho_ConnectedRegions, ho_SelectedRegions, ho_SortedRegions = null;
        HObject ho_ObjectSelected1 = null, ho_ObjectSelected2 = null;
        HObject ho_Rectangle1, ho_Rectangle2, ho_RegionUnion1, ho_RegionUnion2;
        HObject ho_ClothRegion, ho_Boxs = null, ho_Rectangle = null;
        HObject ho_ImageReduced = null, ho_ImageMedian = null, ho_Region1 = null;
        HObject ho_ImageMedianReduced = null, ho_ImageR = null, ho_ImageG = null;
        HObject ho_ImageB = null, ho_ImageL = null, ho_ImageA = null;
        HObject ho_ClothRegionImage = null, ho_ImageMedian1 = null;
        HObject ho_Region2 = null, ho_RegionClosing1 = null, ho_ClothRegionErosion = null;
        HObject ho_DefectRegion1 = null, ho_ImageMean = null, ho_ImageSub = null;
        HObject ho_Regions = null, ho_RegionOpening1 = null, ho_RegionOpening2 = null;
        HObject ho_RegionUnion = null, ho_RegionIntersection = null;
        HObject ho_RegionFillUp = null, ho_ConnectedRegions1 = null;
        HObject ho_SelectedRegions1 = null, ho_RegionDilation = null;
        ...
        HTuple hv_Column12 = new HTuple(), hv_Row22 = new HTuple();
        HTuple hv_Column22 = new HTuple(), hv_Convexity1 = new HTuple();
        HTuple hv_Convexity2 = new HTuple(), hv_Length, hv_boxDistance = new HTuple();
        HTuple hv_boxBenginY = new HTuple(), hv_tupleDeviationL = new HTuple();
        HTuple hv_tupleDeviationA = new HTuple(), hv_tupleDeviationB = new HTuple();
        HTuple hv_i = new HTuple(), hv_MeanL = new HTuple(), hv_DeviationL = new HTuple();
        HTuple hv_MeanA = new HTuple(), hv_DeviationA = new HTuple();
        ...
        HTuple hv_Row = new HTuple(), hv_Column = new HTuple(), hv_Area1 = new HTuple();
        ...
        try
        {
            ...
            ho_Rectangle1.Dispose();
            HOperatorSet.GenRectangle1(out ho_Rectangle1, 1, 0, 2, hv_Width);
            ho_Rectangle2.Dispose();
            HOperatorSet.GenRectangle1(out ho_Rectangle2, hv_Height - 1, 1, hv_Height, hv_Width);
            ho_RegionUnion1.Dispose();
            HOperatorSet.Union2(ho_Rectangle1, ho_Rectangle2, out ho_RegionUnion1);
            ho_RegionUnion2.Dispose();
            HOperatorSet.Union2(ho_RegionUnion1, ho_SelectedRegions, out ho_RegionUnion2
                );
            ho_ClothRegion.Dispose();
            HOperatorSet.FillUp(ho_RegionUnion2, out ho_ClothRegion);
            ...
            if ((int)(new HTuple(hv_result.TupleEqual(0))) != 0)
            {
                ...
                ho_Region2.Dispose();
                HOperatorSet.VarThreshold(ho_ImageMedian1, out ho_Region2, 15, 15, 0.2, hv_dynThresh,
                    "not_equal");
                ho_RegionClosing1.Dispose();
                HOperatorSet.ClosingRectangle1(ho_ClothRegion, out ho_RegionClosing1, 1,
                    20);
                ho_ClothRegionErosion.Dispose();
                HOperatorSet.ErosionCircle(ho_RegionClosing1, out ho_ClothRegionErosion,
                    40);

                ho_DefectRegion1.Dispose();
                HOperatorSet.ClosingCircle(ho_Region2, out ho_DefectRegion1, 5);

                ho_ImageMean.Dispose();
                HOperatorSet.RegionToMean(ho_ClothRegion, ho_ClothRegionImage, out ho_ImageMean
                    );
                ho_ImageSub.Dispose();
                HOperatorSet.SubImage(ho_ClothRegionImage, ho_ImageMean, out ho_ImageSub,
                    1, 128);
                ho_Regions.Dispose();
                HOperatorSet.Threshold(ho_ImageSub, out ho_Regions, 216, 255);
                ho_RegionOpening1.Dispose();
                HOperatorSet.OpeningCircle(ho_Regions, out ho_RegionOpening1, 1.5);
                ho_Regions.Dispose();
                HOperatorSet.Threshold(ho_ImageSub, out ho_Regions, 0, 55);
                ho_RegionOpening2.Dispose();
                HOperatorSet.OpeningCircle(ho_Regions, out ho_RegionOpening2, 1.5);
                ho_RegionUnion.Dispose();
                HOperatorSet.Union2(ho_RegionOpening1, ho_RegionOpening2, out ho_RegionUnion
                    );
                OTemp[SP_O] = ho_RegionUnion.CopyObj(1, -1);
                SP_O++;
                ho_RegionUnion.Dispose();
                HOperatorSet.Union2(OTemp[SP_O - 1], ho_DefectRegion, out ho_RegionUnion);
                OTemp[SP_O - 1].Dispose();
                SP_O = 0;
                ho_RegionIntersection.Dispose();
                HOperatorSet.Intersection(ho_RegionUnion, ho_ClothRegionErosion, out ho_RegionIntersection
                    );
                ...
                if ((int)(new HTuple(hv_Area.TupleGreater(0))) != 0)
                {
                    ...
                    HOperatorSet.AreaCenter(ho_ConnectedRegions2, out hv_Area1, out hv_tupleDefectY,
                        out hv_tupleDefectX);
                    HOperatorSet.SmallestCircle(ho_ConnectedRegions2, out hv_tupleDefectY,
                        out hv_tupleDefectX, out hv_tupleDefectRadius);
                    HOperatorSet.CountObj(ho_ConnectedRegions2, out hv_defectNumber);
    ...
    public void get_defect_aberration1(HObject ho_Image, HTuple hv_WindowHandle, HTuple hv_boxNumber,
        HTuple hv_boxWidth, HTuple hv_boxHeight, HTuple hv_boxBenginX, HTuple hv_medianKernal,
        HTuple hv_dynThresh, HTuple hv_defectArea, HTuple hv_standardTupleL, HTuple hv_standardTupleA,
        HTuple hv_standardTupleB, HTuple hv_clothAberrationGrad1, HTuple hv_clothAberrationGrad2,
        HTuple hv_clothAberrationGrad3, HTuple hv_clothAberrationGrad4, out HTuple hv_result,
        ...
        out HTuple hv_A, out HTuple hv_B)
    {
        ...
        if ((int)(new HTuple(hv_Number.TupleEqual(0))) != 0)
        {
            //未找到布匹
            hv_result = 1;
            disp_message(hv_ExpDefaultWinHandle, "未找到布匹",
                       "window", 10,100, "red", "true");
        ...
        else if ((int)(new HTuple(hv_Number.TupleGreater(1))) != 0)
        {
                ...
                new HTuple(hv_Convexity2.TupleLess(0.97))))) != 0)
            {
                ...
                disp_message(hv_ExpDefaultWinHandle, "接缝布匹",
                      "window", 10,100, "red", "true");
            }
            else
            {
            ...
            hv_boxNumber)))) != 0)
        {
            ...
            hv_clothAberration = ((hv_clothAberration.TupleString("0.3f"))).TupleNumber(); 
        ...
        if ((int)(new HTuple(hv_result.TupleEqual(0))) != 0)
        {
            ...
            if ((int)(new HTuple(hv_Area.TupleGreater(0))) != 0)
            {
                ...
                HOperatorSet.SmallestCircle(ho_ConnectedRegions2, out hv_tupleDefectY, out hv_tupleDefectX,
                    out hv_tupleDefectRadius);
                HOperatorSet.CountObj(ho_ConnectedRegions2, out hv_defectNumber);
                HOperatorSet.DispObj(ho_DefectRegion, hv_ExpDefaultWinHandle);
            }
    ...
    public void get_standard_lab(HObject ho_Image, HTuple hv_boxNumber, HTuple hv_boxWidth,
        ...
        out HTuple hv_standardA, out HTuple hv_standardB, out HTuple hv_result)
    {
        ...
        HObject ho_GrayImage, ho_Region, ho_ConnectedRegions;
        HObject ho_SelectedRegions, ho_Boxs = null, ho_Rectangle = null;
        HObject ho_ImageReduced = null, ho_ImageMedian = null, ho_Region1 = null;
        HObject ho_ImageMedianReduced = null, ho_ImageR = null, ho_ImageG = null;
        HObject ho_ImageB = null, ho_ImageL = null, ho_ImageA = null;
        ...
        HTuple hv_Width, hv_Height, hv_Number, hv_WindowHandle = new HTuple();
        ...
        else
        {
            ...
            HOperatorSet.SetLineWidth(hv_ExpDefaultWinHandle, 2);
            HOperatorSet.DispObj(ho_Boxs, hv_ExpDefaultWinHandle);
            disp_message(hv_ExpDefaultWinHandle, "标准色差获取成功", "window", 10,100,
                "green", "true");
        ...
        out HTuple hv_A, out HTuple hv_B)
    {
        ...
        get_defect_aberration(ho_Image, hv_WindowHandle, hv_boxNumber, hv_boxWidth, hv_boxHeight,
            hv_boxBenginX, hv_medianKernal, hv_dynThresh, hv_defectArea, hv_standardTupleL,
            hv_standardTupleA, hv_standardTupleB, hv_clothAberrationGrad1, hv_clothAberrationGrad2,
            hv_clothAberrationGrad3, hv_clothAberrationGrad4, out hv_result, out hv_defectNumber,
            out hv_tupleDefectX, out hv_tupleDefectY, out hv_tupleDefectRadius, out hv_clothAberration,
            out hv_L, out hv_A, out hv_B);
    ...
    private void action(HObject ho_Image, HTuple Window,out HTuple hv_dE)
    {
        ...
        get_standard_lab(ho_Image1, hv_boxNumber, hv_boxWidth, hv_boxHeight, hv_boxBenginX,
